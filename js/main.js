...
(function ($) {
    ...
    /*------------------
        CountDown
    --------------------*/
	$("#countdown").countdown("2020/4/4", function(event) {
        $(this).html(event.strftime("<div class='cd-item'><span>%D</span> <p>Tage</p> </div>" + "<div class='cd-item'><span>%H</span> <p>Stunden</p> </div>" + "<div class='cd-item'><span>%M</span> <p>Minuten</p> </div>" + "<div class='cd-item'><span>%S</span> <p>Sekunden</p> </div>"));
    });

    $("#countdown-2").countdown("2020/4/4", function(event) {
